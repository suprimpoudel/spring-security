package com.np.suprimpoudel.util.helper;
...
public class JwtHelper {
    @Value("${com.np.suprimpoudel.util.helper.secretKey}")
    private String secretKey;

    @Value("${com.np.suprimpoudel.util.helper.expirationTime}")
    ...
    public Boolean isTokenValid(String token, UserDetails userDetails) {
        ...
        final String username = extractCode(token);
